                  ...
                  <div className="space-y-5">
                    <div className="flex flex-col sm:flex-row sm:justify-between gap-2">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <span className="px-3 py-1 bg-[#1DD2AE] text-[#171417] text-sm rounded-lg">
                          Seller
                        </span>
                      </div>
                    </div>
                    <div className="flex flex-col sm:flex-row sm:justify-between gap-2">
                      <span className="font-dm-sans font-medium text-base text-[#171417]">Email Address</span>
                      <span className="font-dm-sans text-base text-[#454345] break-all">{subscription.email}</span>
                    </div>
                    <div className="flex flex-col sm:flex-row sm:justify-between gap-2">
                      <span className="font-dm-sans font-medium text-base text-[#171417]">Phone Number</span>
                      <span className="font-dm-sans text-base text-[#454345]">{subscription.phone}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex flex-col sm:flex-row sm:justify-between gap-2">
                      ...
                      <span className="font-dm-sans text-base text-[#454345]">{subscription.planType}</span>
                    </div>
                    <div className="flex flex-col sm:flex-row sm:justify-between gap-2">
                      <span className="font-dm-sans font-medium text-base text-[#171417]">Start Date</span>
                      <span className="font-dm-sans text-base text-[#454345]">{subscription.startDate}</span>
                    </div>
                    <div className="flex flex-col sm:flex-row sm:justify-between gap-2">
                      <span className="font-dm-sans font-medium text-base text-[#171417]">End Date</span>
                      <span className="font-dm-sans text-base text-[#454345]">{subscription.endDate}</span>
                    </div>
                    <div className="flex flex-col sm:flex-row sm:justify-between gap-2">
                      <span className="font-dm-sans font-medium text-base text-[#171417]">Payment Status</span>
